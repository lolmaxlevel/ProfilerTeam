...
class PDF(FPDF):
   ...
   def chapter_body(self, num, txt):
      if num == 3:
         ...
         self.ln(15)
         self.set_font("Opel Sans", size=14)
         self.multi_cell(0, 5, txt.split("!")[4])
         self.ln(5)
         self.set_font("Opel Sans", size=12)
         self.multi_cell(0, 5, txt.split("!")[5])
         self.ln(15)
         self.set_font("Opel Sans", size=14)
         self.multi_cell(0, 5, txt.split("!")[6])
         self.ln(5)
         self.set_font("Opel Sans", size=12)
         self.multi_cell(0, 5, txt.split("!")[7])
         self.ln()
      else:
         self.set_font("Opel Sans", size=12)
...
def pdf_report(uid, name, uinfo, uinfo2, uinfo3):
    ...
    pdf.print_chapter(1, utype, uinfo.split("|")[1])
    pdf.print_chapter(2, utype2, uinfo2.split("|")[1])
    pdf.print_chapter(3, utype3, uinfo3.split("|")[1])
    pdf.output(f"E:\\User data\\Documents\\GitHub\\dukhov\\ProfilerTeam\\reports\\{uid}.pdf")
...
def answer(webAppMes):
   ...
   if data[0] == "t1":
      ...
      while f"{webAppMes.chat.id}.pdf" not in files:
         time.sleep(2.5)
         files = os.listdir("E:\\User data\\Documents\\GitHub\\dukhov\\ProfilerTeam\\reports")
